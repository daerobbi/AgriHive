...
<div class="max-w-6xl mx-auto mt-8 bg-white p-8 rounded-md shadow">
        ...
        <div class="flex flex-col items-center">
            ...
            <button class="mt-4 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 flex items-center gap-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a1 1 0 001 1h14a1 1 0 001-1v-1m-4-4l-4-4m0 0l-4 4m4-4v12"/>
                </svg>
            </button>
        </div>
    ...
    <div class="flex justify-end mt-6 space-x-4">
        ...
        <button onclick="openModalHapus('')" class="bg-green-700 hover:bg-green-800 text-white px-6 py-2 rounded">Simpan</button>
    </div>
</div>
