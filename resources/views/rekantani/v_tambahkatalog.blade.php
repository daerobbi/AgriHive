...
@section('content')
    ...
    <div x-data="{ modalHapus: false, modalSukses: false, modalGagal: false }">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div x-data="{ imagePreview: null }" class="flex flex-col items-center">
                        <div
                            ...
                            <template x-if="!imagePreview">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-gray-400 pointer-events-none"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select class="w-full border border-gray-300 rounded px-3 py-2 mt-1" name="jenis_bibit">
                        ...
                        <div>
                            ...
                            <textarea rows="5" class="w-full border border-gray-300 rounded px-3 py-2 mt-1" name="deskripsi"></textarea>
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal Konfirmasi -->
        <div x-show="modalHapus" x-transition x-cloak
            ...
            <div class="bg-white rounded-3xl p-8 w-full max-w-md text-center shadow-lg" @click.away="modalHapus = false">
                ...
                <div class="flex justify-center gap-6">
                    <button @click="modalHapus = false"
                        class="bg-red-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-red-700">Batal</button>
                    <button
                        @click="
                    modalHapus = false;
        ...
        <!-- Modal Sukses -->
        <div x-show="modalSukses" x-transition x-cloak
            class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
        ...
        <div x-show="modalGagal" x-transition x-cloak
            class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white rounded-3xl p-8 w-full max-w-md text-center shadow-lg">
