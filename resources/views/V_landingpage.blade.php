...
<body class="bg-[#e9eaea]">
    <header class="flex justify-between items-center px-6 sm:px-10 md:px-16 lg:px-24 py-6 max-w-[1280px] mx-auto">
        <div class="flex items-center space-x-3">
            <img src="{{ asset('asset/logo_hijau.png') }}" alt="AgriHive logo with green background and white text"
            ...
            <div class="flex-1 flex flex-col gap-6">
                <div class="bg-[#1f6f4f] rounded-md p-6">
                    ...
                    <p class="text-white text-xs sm:text-sm font-semibold leading-snug max-w-3xl">
                        AGRIHIVE adalah platform digital yang mempertemukan rekan tani dan agen bibit untuk saling
            ...
            <div class="space-y-4 max-w-[350px] text-xs">
                ...
                <ul class="space-y-2">
                    <li class="flex items-center gap-2">
                        ...
                        <a href="mailto:adminAgrihive@mail.com" class="hover:underline">adminAgrihive@mail.com</a>
                    </li>
                    <li class="flex items-center gap-2">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="https://instagram.com/Agrihive.id" class="hover:underline">Agrihive.id</a>
                    </li>
                </ul>
            </div>
        </div>
