<html lang="id">
    ...
    <header class="px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 pt-6 flex justify-end gap-4">
    <a href="{{ route('login') }}" class="bg-[#1f6f4f] text-white rounded-full px-6 py-2 text-sm font-semibold flex items-center gap-2 hover:brightness-110 transition">
        Login
