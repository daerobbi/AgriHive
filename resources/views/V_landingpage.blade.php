<html lang="id">
    ...
    <header class="flex justify-between items-center px-6 sm:px-10 md:px-16 lg:px-24 py-6 max-w-[1280px] mx-auto">
        <div class="flex items-center space-x-3">
            <img
                src="{{ asset('asset/logo_hijau.png') }}"
                alt="AgriHive logo with green background and white text"
                class="w-14 h-14"
                width="56"
                height="56"
            />
            <span class="text-3xl font-bold text-[#144d2b] select-none">AgriHive</span>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('login') }}" class="bg-[#1f7a4a] text-white px-5 py-2 rounded-full flex items-center gap-2 text-sm font-semibold hover:bg-[#166032] transition">
                Login
    ...
    <h1 class="text-[28px] sm:text-[36px] md:text-[40px] lg:text-[44px] font-extrabold max-w-4xl mb-2 leading-tight">
        Semua Bisa di
    ...
    <p class="text-[#1f6f4f] max-w-3xl text-sm sm:text-base leading-relaxed mb-8">
        Dapatkan bibit sesuai kebutuhanmu atau terima permintaan dari mitra. Semua proses dalam satu platform yang menghubungkan petani dan agen secara langsung
    </p>
    <div class="flex flex-col lg:flex-row gap-6 max-w-5xl mx-auto">
        ...
        AGRIHIVE adalah platform digital yang mempertemukan rekan tani dan agen bibit untuk saling terkoneksi, saling mendukung, dan mempercepat proses distribusi bibit tanaman hortikultura. Kami hadir untuk menciptakan ekosistem pertanian yang lebih efisien, transparan, dan saling menguntungkan.
        </p>
        </div>
        ...
        <ul class="text-xs text-[#4a4a4a] space-y-2">
            <li class="flex gap-2">
            <div class="flex items-center justify-center w-6 h-6 bg-[#b9e6c9] rounded-md text-[#1f6f4f]">
        ...
        <div class="flex-1 flex justify-center items-center">
        <img
            alt="Wanita tersenyum memegang kotak kardus berisi sayur dan buah segar seperti selada, pisang, apel, tomat, dan anggur"
            class="w-[480px] h-[480px] object-contain rounded-md"
            height="480"
            src="{{ asset('asset/orangbawabuah.png') }}"
            width="480"
        />
        </div>
    ...
    <div class="border-t border-gray-300 pt-6">
        ...
        <div class="bg-[#c9f7d9] rounded-full w-[80px] h-[80px] flex items-center justify-center text-[#1f6f4f] text-xl sm:text-2xl font-semibold">
        30+
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <img alt="Foto close-up jahe, kunyit, temulawak, dan herbal lainnya di atas meja kayu" class="rounded-lg w-[100px] h-[80px] object-cover" height="80" src="https://storage.googleapis.com/a1aa/image/9664f36b-029f-4924-1c73-554220cec70b.jpg" width="100"/>
        </div>
        <div>
        ...
        <img alt="Foto sayuran kangkung, bayam, sawi segar di kebun" class="rounded-lg w-[100px] h-[80px] object-cover" height="80" src="https://storage.googleapis.com/a1aa/image/fa193f21-1aa3-4e4f-4931-b1c212bacd4f.jpg" width="100"/>
        </div>
        <div>
        <h4 class="font-extrabold text-sm mb-1">
        Sayuran
        ...
        <img alt="Foto buah mangga, jeruk, pisang segar dalam keranjang" class="rounded-lg w-[100px] h-[80px] object-cover" height="80" src="https://storage.googleapis.com/a1aa/image/4d9f32d2-8dd9-4931-3580-1d59196561d6.jpg" width="100"/>
        </div>
        <div>
        <h4 class="font-extrabold text-sm mb-1">
        Buah Buahan
        ...
        <img alt="Foto bunga hias merah segar dengan latar belakang hijau" class="rounded-lg w-[100px] h-[80px] object-cover" height="80" src="https://storage.googleapis.com/a1aa/image/e0a02e00-1c19-493b-f584-df1b18d8cd6e.jpg" width="100"/>
        </div>
        <div>
        <h4 class="font-extrabold text-sm mb-1">
        Tanaman Hias
