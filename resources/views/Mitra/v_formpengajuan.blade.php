...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-10">
        ...
        <form id="pengajuanForm" class="space-y-5">
            <!-- Input Fields -->
            <div>
...
<div id="confirmationModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-gray-300 rounded-[50px] p-10 text-center">
        ...
        <div class="flex justify-center gap-8">
            <button onclick="closeModal()" class="bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-2 rounded-full">Batal</button>
            <button onclick="submitForm()" class="bg-green-700 hover:bg-green-800 text-white font-bold px-8 py-2 rounded-full">Yakin</button>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('pengajuanForm').addEventListener('submit', function (e) {
        ...
        showModal(); // Tampilkan modal konfirmasi
    });
</script>
